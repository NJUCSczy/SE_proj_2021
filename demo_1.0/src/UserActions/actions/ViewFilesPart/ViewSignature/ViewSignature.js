...
import { getStageByInfo, getStatusInfo,getStageByDelegationState, USE_JSON_SERVER,REMOTE_SERVER } from '../../../functions/functions'
            ...
            fetch(REMOTE_SERVER + "/contract/" + _state['PageInfo']['ContractID'], {
                ...
                .then(data => {
                    ...
                    if (data != null) {
                        setEntrustData(prev => {
                            const newData = _.cloneDeep(prev)
                            newData['委托人签章'] = data['contractTable']['ContractTablePartyA']
                            newData['市场部签章'] = data['contractTable']['ContractTablePartyB']
    ...
    return (
        entrustData['formDsta'] === null ? null : (
            <Form
                ...
                {(USE_JSON_SERVER? getStageByInfo(entrustData['formData']):(getStageByDelegationState(entrustData['formData']['contractState']))) < 19 ? null : (
                    <div>
                ...
                {USE_JSON_SERVER? getStageByInfo(entrustData['formData']):getStageByDelegationState(entrustData['formData']['contractState']) < 18 ? null : (
                    <div>
                        <h3 style={{ fontWeight: 'bolder', marginTop: 30 }}>单位全称</h3>
