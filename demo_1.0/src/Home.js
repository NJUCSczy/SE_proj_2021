...
class Home extends React.Component {
    ...
    render() {
        ...
        const Breadcrumbitems = {
            ...
            "填写软件测试方案": <Breadcrumb.Item><a onClick={() => { this.GotoPage('TestPlan', this.state) }}>填写软件测试方案</a></Breadcrumb.Item>,
            "填写测试报告检查表": <Breadcrumb.Item><a onClick={() => { this.GotoPage('CheckList', this.state) }}>填写测试报告检查表</a></Breadcrumb.Item>,
            "填写软件测试问题清单": <Breadcrumb.Item><a onClick={() => { this.GotoPage('QuestionList', this.state) }}>填写软件测试问题清单</a></Breadcrumb.Item>,
            "填写软件文档评审表": <Breadcrumb.Item><a onClick={() => { this.GotoPage('SoftwareDocumentReviewForm', this.state) }}>填写软件文档评审表</a></Breadcrumb.Item>,
            "填写测试用例电子记录": <Breadcrumb.Item><a onClick={() => { this.GotoPage('TestCase', this.state) }}>填写测试用例电子记录</a></Breadcrumb.Item>,
            "填写软件项目委托测试工作检查表": <Breadcrumb.Item><a onClick={() => { this.GotoPage('TestCheckList', this.state) }}>填写软件项目委托测试工作检查表</a></Breadcrumb.Item>,
            "填写软件测试记录电子记录": <Breadcrumb.Item><a onClick={() => { this.GotoPage('TestRecord', this.state) }}>填写软件测试记录电子记录</a></Breadcrumb.Item>,
            "填写软件测试报告": <Breadcrumb.Item><a onClick={() => { this.GotoPage('TestReport', this.state) }}>填写软件测试报告</a></Breadcrumb.Item>,
            "填写测试方案评审表": <Breadcrumb.Item><a onClick={() => { this.GotoPage('TestScenarioReviewForm', this.state) }}>填写测试方案评审表</a></Breadcrumb.Item>,
            ...
            "查看项目列表": <Breadcrumb.Item><a onClick={() => { this.GotoPage('ViewProjList', this.state) }}>查看项目列表</a></Breadcrumb.Item>,
            "查看项目": <Breadcrumb.Item><a onClick={() => { this.GotoPage('ViewProject', this.state) }}>查看项目</a></Breadcrumb.Item>,
            "查看软件测试方案": <Breadcrumb.Item><a onClick={() => { this.GotoPage('ViewTestPlan', this.state) }}>查看软件测试方案</a></Breadcrumb.Item>,
            "查看测试报告检查表": <Breadcrumb.Item><a onClick={() => { this.GotoPage('Viewchecklist', this.state) }}>查看测试报告检查表</a></Breadcrumb.Item>,
            "查看软件测试问题清单": <Breadcrumb.Item><a onClick={() => { this.GotoPage('Viewquestionlist', this.state) }}>查看软件测试问题清单</a></Breadcrumb.Item>,
            "查看软件文档评审表": <Breadcrumb.Item><a onClick={() => { this.GotoPage('Viewsdreviewform', this.state) }}>查看软件文档评审表</a></Breadcrumb.Item>,
            "查看测试用例电子记录": <Breadcrumb.Item><a onClick={() => { this.GotoPage('ViewTestCase', this.state) }}>查看测试用例电子记录</a></Breadcrumb.Item>,
            "查看软件项目委托测试工作检查表": <Breadcrumb.Item><a onClick={() => { this.GotoPage('Viewtestchecklist', this.state) }}>查看软件项目委托测试工作检查表</a></Breadcrumb.Item>,
